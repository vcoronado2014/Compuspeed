        ...
        (function ($) {
            ...
            $.simpleWeather({
                ...
                success: function (weather) {
                    ...
                    html1 += '<li class="currently">' + transformarPronostico(weather.code) + '</li>';
                    html1 += '<li>Min/Max: ' + weather.low + ' - ' + weather.high + ' &deg;C</li></ul>';
                    html1 += "<hr>";
                    $("#weather1").html(html1);
                    showAndroidToast(weather.code + '|' + weather.tomorrow.code);
            ...
            function entregaHora() {
                ...
                document.getElementById('hora').innerHTML = html1 + h + ":" + m + ":" + s;
            ...
            function actualizarAfuera(woeidMostrar) {
                $.simpleWeather({
                    woeid: woeidMostrar,
                    location: '',
                    unit: 'c',
